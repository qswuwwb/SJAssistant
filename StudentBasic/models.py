...
class ClassInfo(models.Model):
    ...
    assistant = models.ForeignKey(Assistant, verbose_name="项目经理", on_delete=models.SET_NULL)
    head_teacher = models.ForeignKey(HeadTeacher, verbose_name="班主任", on_delete=models.SET_NULL)
